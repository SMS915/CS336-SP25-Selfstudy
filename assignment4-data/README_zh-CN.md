...
| **过滤步骤 (顺序)**           | **移除数量 (Removed)** | **剩余数量 (Remaining)** | **移除占总数比 (Global %)** | **当前步骤移除率 (Step Loss %)** | **当前步骤留存率 (Pass Rate)** |
| ----------------------------- | ---------------------- | ------------------------ | --------------------------- | -------------------------------- | ------------------------------ |
| **0. 原始输入**               | -                      | **2,711,873**            | -                           | -                                | 100%                           |
| **1. 短文本过滤** (`short`)   | 92,386                 | 2,619,487                | 3.41%                       | 3.41%                            | **96.59%**                     |
| **2. 语言过滤** (`lang`)      | 2,579,190              | 40,297                   | 95.11%                      | **98.46%**                       | **1.54%**                      |
| **3. NSFW过滤** (`nsfw`)      | 312                    | 39,985                   | 0.01%                       | 0.77%                            | **99.23%**                     |
| **4. 有毒言论过滤** (`toxic`) | 611                    | 39,374                   | 0.02%                       | 1.53%                            | **98.47%**                     |
| **5. Gopher规则** (`gopher`)  | 6,845                  | 32,529                   | 0.25%                       | 17.38%                           | **82.62%**                     |
| **6. 质量分类器** (`quality`) | 22,977                 | **9,552**                | 0.85%                       | **70.64%**                       | **29.36%**                     |

 - other_record_type: 101, 0.00%
 - total: 2711873, 100.00%
 - lang_failed: 2579190, 95.11%
 - short_count: 92386, 3.41%
 - quality_failed: 22977, 0.85%
 - gopher_failed: 6845, 0.25%
 - kept: 9552, 0.35%
 - nsfw_failed: 312, 0.01%
 - toxic_failed: 611, 0.02%
