...
WIKI_PATH_DIR="data/wiki_links"
mkdir -p $WIKI_PATH_DIR

echo "正在下载维基百科外部链接URL列表 (enwiki-20240420-extracted_urls.txt.gz)..."
wget -c -P $WIKI_PATH_DIR https://nlp.stanford.edu/data/nfliu/cs336-spring-2024/assignment4/enwiki-20240420-extracted_urls.txt.gz
