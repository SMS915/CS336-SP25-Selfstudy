...
def plot_pass_k_curve(results_list, task_name: str, show_k_list=[1, 2, 4, 8], text: bool= True):
    ...
    STYLE_CONFIG = {
        'no_std_norm_grpo': {'color': '#E11D48', 'z': 20, 'lw': 3.5, 'marker': 's', 'alpha': 1.0},  # 核心实验：玫瑰红
...
if __name__ == "__main__":
    ...
    math_test_pass8_results  = [baseline_math_test_pass8_result, sft_math_test_pass8_result, no_std_norm_grpo_full_pass8_result, grpo_math_test_pass8_result, drgrpo_math_test_pass8_result, instruct_math_test_pass8_result]
    math500_pass64_results   = [baseline_500_pass64_result, sft_500_pass64_result, grpo_500_pass64_result, no_std_norm_grpo_500_pass64_result, drgrpo_math500_pass64_result, instruct_500_pass64_result]
    amc12_pass64_results     = [baseline_AMC12_pass64_result, sft_AMC12_pass64_result, grpo_AMC12_pass64_result, no_std_norm_grpo_AMC12_pass64_result, drgrpo_amc_pass64_result, instruct_AMC_12_pass64_result]
    aime_2025_pass64_results = [baseline_aime25_pass64_result, sft_aime25_pass64_result, grpo_aime25_pass64_result, no_std_norm_grpo_aime25_pass64_result, drgrpo_aime25_pass64_result, instruct_aime25_pass64_result]
    aime_2024_pass64_results = [baseline_aime24_pass64_result, sft_aime24_pass64_result, grpo_aime24_pass64_result, no_std_norm_grpo_aime24_pass64_result, drgrpo_aime24_pass64_result, instruct_aime24_pass64_result]
