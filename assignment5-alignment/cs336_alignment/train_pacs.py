...
bootstrap_cuda_visible_devices(default_config_path="configs/train/pacs_config.yaml")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", type=str, default="configs/train/pacs_config.yaml")
